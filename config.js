...
global.packname = '🌸 Ania Bot • Modo Kawaii 💗'
global.author = 'Yuly & Wilker | © 2025 🌸'
global.moneda = 'Flores 🌸'
...
global.status = [
  ...
  { type: 'Listening', message: '💗 House Ania' },
...
watchFile(file, () => {
  unwatchFile(file)
  console.log(chalk.hex('#FF9EBD')("🌸 Se actualizó 'config.js' - ANIA BOT REINICIADA 💗"))
