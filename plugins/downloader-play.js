...
try {
if (!text.trim()) return conn.reply(m.chat, `✪ Ingresa un nombre o enlace de YouTube.`, m)
await m.react('🕒')
...
if (seconds > 1800) throw '⚠ El contenido es muy largo.'
const vistas = formatViews(views)
const info = `୨˚⋆ Descarga en camino ⋆˚୧
